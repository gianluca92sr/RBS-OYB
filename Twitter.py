...
def cleaning_tweets(t):
    ...
    text_tweet_no_link_spec_char = re.sub(pattern_link_special_char, ' ', text_tweet_no_mentions)
...
df = pd.DataFrame(list(
    zip(tweets_text, tweets_replies, tweets_retweets, tweets_likes, (pd.to_datetime(tweets_time, format='%H:%M:%S')).time)),
...
wordcloud_hash = WordCloud(width=1600, stopwords=stopwords, height=800, max_font_size=200, max_words=50, collocations=False,
